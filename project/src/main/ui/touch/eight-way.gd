...
@export var hold_button_path: NodePath
...
@export var up_right_weight := 0.0 # (float, 0, 1)
@export var up_left_weight := 0.0 # (float, 0, 1)
@export var down_right_weight := 0.0 # (float, 0, 1)
@export var down_left_weight := 0.0 # (float, 0, 1)
