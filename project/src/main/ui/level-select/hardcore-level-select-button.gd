...
func refresh_style_color(_color: Color) -> void:
	button_control.get("theme_override_styles/normal").bg_color = BUTTON_COLOR_HARDCORE
	button_control.get("theme_override_styles/hover").bg_color = BUTTON_COLOR_HARDCORE
