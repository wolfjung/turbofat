...
func _ready() -> void:
	...
	_give_up_confirmation.get_ok_button().text = tr("Yes")
	_give_up_confirmation.get_cancel_button().text = tr("No")
	_give_up_confirmation.connect("confirmed", Callable(self, "_on_GiveUpConfirmation_confirmed"))
	_give_up_confirmation.get_cancel_button().connect("pressed", Callable(self, "_on_GiveUpConfirmation_cancelled"))
	_give_up_confirmation.get_close_button().connect("pressed", Callable(self, "_on_GiveUpConfirmation_cancelled"))
